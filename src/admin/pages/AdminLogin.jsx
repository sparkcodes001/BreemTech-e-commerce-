...
const AdminLogin = () => {
  ...
  const { login, error, clearError, isAuthenticated } = useAdminAuthStore();
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div ref={logoRef} className="text-center mb-8">
          <div
            ...
            w-16 h-16 rounded-2xl bg-accent/10 border border-accent/30
            mb-4"
          >
        ...
        >
          ...
          >
            ...
            <p className="text-primary-400 text-xs">📧 admin@nexus.com</p>
            <p className="text-primary-400 text-xs">🔑 admin123</p>
          </div>
        </div>
